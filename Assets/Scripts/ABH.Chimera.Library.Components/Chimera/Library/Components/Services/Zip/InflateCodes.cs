...
namespace Chimera.Library.Components.Services.Zip
{
	internal sealed class InflateCodes
	{
		...
		{
			var codec = blocks._codec;
			var num = codec.NextIn;
			var num2 = codec.AvailableBytesIn;
			var num3 = blocks.bitb;
			var i = blocks.bitk;
			var num4 = blocks.writeAt;
			var num5 = num4 < blocks.readAt ? blocks.readAt - num4 - 1 : blocks.end - num4;
			for (;;)
			{
				int num6;
				switch (this.mode)
				...
				var num7 = (this.tree_index + (num3 & InternalInflateConstants.InflateMask[num6])) * 3;
				num3 >>= this.tree[num7 + 1];
				i -= this.tree[num7 + 1];
				var num8 = this.tree[num7];
				if (num8 == 0)
				{
			...
			r = blocks.Flush(r);
			num4 = blocks.writeAt;
			var num9 = num4 < blocks.readAt ? blocks.readAt - num4 - 1 : blocks.end - num4;
		...
		internal int InflateFast(int bl, int bd, int[] tl, int tl_index, int[] td, int td_index, InflateBlocks s, ZlibCodec z)
		{
			...
			var i = s.bitk;
			var num4 = s.writeAt;
			var num5 = num4 < s.readAt ? s.readAt - num4 - 1 : s.end - num4;
			...
			for (;;)
			{
				...
				else
				{
					...
					var num12 = td[num9 + 2] + (num3 & InternalInflateConstants.InflateMask[num10]);
					num3 >>= num10;
					i -= num10;
					num5 -= num11;
					int num13;
