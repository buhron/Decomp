...
public class AnimateNGUIAlphaAnimator : MonoBehaviour
{
	...
	private void LateUpdate()
	{
		...
		var animatorClipInfo = m_animation.GetCurrentAnimatorClipInfo(0)[0];
		var currentAnimatorStateInfo = m_animation.GetCurrentAnimatorStateInfo(0);
		m_ClipName = animatorClipInfo.clip.name;
		foreach (var animCurf in m_animCurves)
		{
