...
public class GooglePlayServicesManager : MonoBehaviour
{
	...
	public void Init()
	{
		...
		using (var androidJavaClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
		{
			...
			m_unityGoogleGamesClientBridge.SetStatic("ON_SIGNIN_FAILED_METHOD", ON_SIGNIN_FAILED_METHOD);
			m_unityGoogleGamesClientBridge.SetStatic("ON_SIGNIN_SUCCEEDED_METHOD", ON_SIGNIN_SUCCEEDED_METHOD);
