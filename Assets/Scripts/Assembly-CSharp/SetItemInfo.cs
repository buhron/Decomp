...
public class SetItemInfo : MonoBehaviour
{
	...
	public void SetModel(EquipmentGameData equipmentGameData, BirdGameData selectedBird, bool isArena)
	{
		...
		if (m_SetBonusTextLabel)
		{
			if (isArena)
			{
				var skillBattleDataBase = m_Item.PvpSetItemSkill.GenerateSkillBattleData();
			...
			{
				var skillBattleDataBase2 = m_Item.SetItemSkill.GenerateSkillBattleData();
