...
public class BattlePrepCharacterButton : MonoBehaviour
{
	...
	{
		var gameObject = (GameObject)UnityEngine.Object.Instantiate(m_CampViewController, base.transform.position, base.transform.rotation);
	...
	{
		var componentsInChildren = base.gameObject.GetComponentsInChildren<ScaleController>();
		if (componentsInChildren == null || ScaleMgr.Instance == null) 
			return;
		
		var array = componentsInChildren;
		foreach (var scaleController in array)
		{
