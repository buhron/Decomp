...
public class ChronicleCaveFloorProxy : ChronicleCaveFloorSlot
{
	...
	{
		var num = hotspot.ProgressId - DIContainerBalancing.Service.GetBalancingData<ChronicleCaveHotspotBalancingData>(ccfbd.FirstChronicleCaveHotspotId).ProgressId;
		if (m_ProxyHotspots.Count > num)
		{
			var gameObject = m_ProxyHotspots[num];
