...
public class ResourceCostBlind : MonoBehaviour
{
	...
	public void SetModel(string assetId, UIAtlas atlas, float value, string youHaveText = "", bool ignoreforfree = false, bool removeIconOnFree = true)
	{
		...
		if (value == 0f && !ignoreforfree)
		{
			...
			if (removeIconOnFree && m_Icon != null)
			{
