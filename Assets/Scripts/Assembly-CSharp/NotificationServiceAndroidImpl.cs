...
public class NotificationServiceAndroidImpl : INotificationService
{
	...
	public void Init()
	{
		if (!m_initialized)
		{
			...
			var googleAppId = DIContainerConfig.GetClientConfig().GoogleAppId;
	...
	private void GoogleCloudMessagingManager_registrationSucceededEvent(string registrationId)
	{
		...
		UnregisterGcmEvents();
		m_Notifications = new PushNotifications(ContentLoader.Instance.m_BeaconConnectionMgr.Identity, registrationId);
	...
	public void CancelAllLocalNotifications()
	{
		...
		foreach (var scheduledNotification in m_scheduledNotifications)
		{
	...
	public void ClearLocalNotifications()
	{
		...
		foreach (var localNotification in m_localNotifications)
		{
	...
	public void ClearRemoteNotifications()
	{
		...
		foreach (var remoteNotification in m_remoteNotifications)
		{
