...
public class PlayAnimationSceneMgr : CoreStateMgr
{
	...
	{
		foreach (var balancingData in DIContainerBalancing.Service.GetBalancingDataList<BirdBalancingData>())
		{
			m_BalancingDataIds.Add(balancingData.NameId);
		}
		foreach (var balancingData2 in DIContainerBalancing.Service.GetBalancingDataList<PigBalancingData>())
		{
