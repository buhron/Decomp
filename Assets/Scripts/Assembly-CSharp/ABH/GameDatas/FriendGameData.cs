...
namespace ABH.GameDatas
{
	public class FriendGameData
	{
		...
		{
			get { return DIContainerLogic.GetTimingService().GetDateTimeFromTimestamp(m_LastBirdRequest); }
		}

		public bool FriendTextureIsLoading
		{
			get { return FriendData != null && m_FriendTextureDownload != null && !m_FriendTextureDownload.isDone; }
		}
		...
		{
			get { return FriendData == null ? 1 : FriendData.Level; }
		}

		public int FriendPvpRank
		{
			get { return FriendData == null ? 15 : FriendData.PvpRank; }
		}

		public int FriendPvpLeague
		{
			get { return FriendData == null ? 6 : FriendData.PvpLeague; }
		}
		...
		public FriendData FriendData
		{
			get
			{
				...
				{
					var publicPlayerData = PublicPlayerData;
