...
{
	public class RevengeOwnRageUse : SkillBattleDataBase
	{
		...
		public override void DoActionInstant(BattleGameData battle, ICombatant source, ICombatant target)
		{
			...
			var battleEffectGameData = new BattleEffectGameData(source, source, new List<BattleEffect>
			{
				new BattleEffect
				{
					EffectTrigger = EffectTriggerType.AfterEnemyRageUsed,
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			var num = Convert.ToInt32(m_DamageMod / 100f * invoker.ModifiedAttack);
