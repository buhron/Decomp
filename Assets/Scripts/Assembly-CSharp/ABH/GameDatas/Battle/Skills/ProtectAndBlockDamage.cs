...
namespace ABH.GameDatas.Battle.Skills
{
	public class ProtectAndBlockDamage : SkillBattleDataBase
	{
		...
		public override IEnumerator DoAction(BattleGameData battle, ICombatant source, ICombatant target, bool shared = false, bool illusion = false)
		{
			...
			if (source != target)
			{
				var valueList = new List<float> { m_Percent };
				...
				var effect3 = new BattleEffectGameData(source, source, new List<BattleEffect>
				{
					new BattleEffect
					{
			...
			{
				var valueList2 = new List<float> { m_Percent };
				var effect2 = new BattleEffectGameData(source, target, new List<BattleEffect>
				{
					new BattleEffect
					{
						EffectTrigger = EffectTriggerType.OnReceiveDamage,
