...
{
	public class PassivePurify : SkillBattleDataBase
	{
		private float m_ChanceToClean;

		public override void Init(SkillGameData model)
		{
			base.Init(model);
			model.SkillParameters.TryGetValue("chance_each_turn", out m_ChanceToClean);
		}
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_1}", m_ChanceToClean.ToString("0"));
