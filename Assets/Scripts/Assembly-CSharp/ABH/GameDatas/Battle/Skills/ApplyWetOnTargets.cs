...
{
	public class ApplyWetOnTargets : AttackSkillTemplate
	{
		...
		public override void Init(SkillGameData model)
		{
			...
			base.Model.SkillParameters.TryGetValue("increase_in_percent", out m_DamageIncrease);
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_5}", string.Empty + base.Model.Balancing.EffectDuration);
			dictionary.Add("{value_2}", string.Empty + m_ChargeTurns);
			dictionary.Add("{value_3}", string.Empty + m_DamageIncrease);
