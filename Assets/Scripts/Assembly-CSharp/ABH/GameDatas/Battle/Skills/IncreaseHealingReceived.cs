...
{
	public class IncreaseHealingReceived : SkillBattleDataBase
	{
		protected float m_IncreaseInPercent;
		...
		{
			base.Init(model);
			base.Model.SkillParameters.TryGetValue("increase_in_percent", out m_IncreaseInPercent);
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_1}", m_IncreaseInPercent.ToString("0"));
