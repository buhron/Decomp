...
{
	public class PassiveVengefulAura : SkillBattleDataBase
	{
		private float m_LifeToDamage;

		public override void Init(SkillGameData model)
		{
			base.Init(model);
			model.SkillParameters.TryGetValue("life_to_damage_ratio", out m_LifeToDamage);
		}
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_1}", m_LifeToDamage.ToString("0"));
