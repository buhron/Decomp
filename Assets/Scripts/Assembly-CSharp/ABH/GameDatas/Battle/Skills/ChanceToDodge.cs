	...
	public class ChanceToDodge : SkillBattleDataBase
	{
		...
		public override void DoActionInstant(BattleGameData battle, ICombatant source, ICombatant target)
		{
			...
			foreach (var target2 in m_Targets)
			{
				...
				var effectTrigger = m_DamageReduction != 100f ? EffectTriggerType.OnReceiveDamage : EffectTriggerType.BeforeReceiveDamage;
				var effectType = m_DamageReduction == 100f ? BattleEffectType.Evade : BattleEffectType.ChanceToReduceDamage;
				list.Add(m_Chance);
