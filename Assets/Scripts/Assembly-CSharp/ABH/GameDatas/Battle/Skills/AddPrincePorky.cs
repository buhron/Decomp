	...
	public class AddPrincePorky : SkillBattleDataBase
	{
		...
		public override IEnumerator DoAction(BattleGameData battle, ICombatant source, ICombatant target, bool shared = false, bool illusion = false)
		{
			...
			if (!done)
			{
				...
				m_Source = source;
				var porky = new BirdGameData("bird_prince_porky", battle.m_CombatantsPerFaction[Faction.Birds][0].CharacterModel.Level);
				var porkyCombatant = new BirdCombatant(porky);
