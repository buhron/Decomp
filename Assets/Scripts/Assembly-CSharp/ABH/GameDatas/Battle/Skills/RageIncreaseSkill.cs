		...
		public override IEnumerator DoAction(BattleGameData battle, ICombatant source, ICombatant target, bool shared = false, bool illusion = false)
		{
			...
			foreach (var skillTarget in m_Targets)
			{
				...
				if (base.Model.SkillParameters.TryGetValue("stun_chance", out effectValue))
				{
					...
					var valueList2 = new List<float> { effectValue, stunDuration };
				...
				var effect = new BattleEffectGameData(source, skillTarget, battleEffectlist, base.Model.Balancing.EffectDuration, battle, base.Model.Balancing.AssetId, SkillEffectTypes.Blessing, GetLocalizedName(), base.Model.SkillNameId);
				effect.AddEffect();
			}
		}
