...
{
	public class PassiveIncreaseHealingAura : SkillBattleDataBase
	{
		private float m_HealBoost;

		public override void Init(SkillGameData model)
		{
			base.Init(model);
			model.SkillParameters.TryGetValue("increase_healing", out m_HealBoost);
		}
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_1}", m_HealBoost.ToString("0"));
