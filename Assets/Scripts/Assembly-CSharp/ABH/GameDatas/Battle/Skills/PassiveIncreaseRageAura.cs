...
{
	public class PassiveIncreaseRageAura : SkillBattleDataBase
	{
		private float m_IncreaseRage;

		public override void Init(SkillGameData model)
		{
			base.Init(model);
			model.SkillParameters.TryGetValue("increase_rage_in_percent", out m_IncreaseRage);
		}
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_1}", m_IncreaseRage.ToString("0"));
