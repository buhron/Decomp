...
{
	public class HealOnDeath : SkillBattleDataBase
	{
		protected float m_HealthInPercent;
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_1}", m_HealthInPercent.ToString("0"));
