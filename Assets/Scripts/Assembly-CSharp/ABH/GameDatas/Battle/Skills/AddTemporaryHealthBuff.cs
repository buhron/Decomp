...
{
	public class AddTemporaryHealthBuff : SkillBattleDataBase
	{
		...
		public override IEnumerator DoAction(BattleGameData battle, ICombatant source, ICombatant target, bool shared = false, bool illusion = false)
		{
			...
			{
				skillTarget.TemporaryHealth = source.ModifiedHealth * m_Percent / 100f;
				...
				var effect = new BattleEffectGameData(source, target, new List<BattleEffect>
				{
					new BattleEffect
					{
						...
						EffectType = BattleEffectType.TemporaryHealthBuff,
						Values = valueList,
		...
		public override string GetLocalizedDescription(ICombatant invoker)
		{
			...
			dictionary.Add("{value_1}", (invoker.ModifiedHealth / (100f / m_Percent)).ToString("0"));
