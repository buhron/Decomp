...
namespace ABH.GameDatas.Battle.Skills
{
	public class SimpleAttackWithDamageBonusFromRage : AttackSkillTemplate
	{
		...
		public override void Init(SkillGameData model)
		{
			...
			{
				var num = m_UseTargetRage != 0f ? battle.GetFactionRage(target.CombatantFaction) : battle.GetFactionRage(source.CombatantFaction);
				var flag = base.Model.SkillParameters.ContainsKey("rage_missing");
				var num2 = m_bonusValue / 100f;
				var num3 = 0f;
				if (flag)
				{
