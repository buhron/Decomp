	...
	public class IncreaseDamageDealtAndReceived : SkillBattleDataBase
	{
		...
		public override IEnumerator DoAction(BattleGameData battle, ICombatant source, ICombatant target, bool shared = false, bool illusion = false)
		{
			...
			foreach (var skillTarget in m_Targets)
			{
				...
				var valueList1 = new List<float> { m_TakenIncrease };
				...
				effect.AddEffect();
				var valueList2 = new List<float> { m_DealtIncrease };
				var effect2 = new BattleEffectGameData(source, skillTarget, new List<BattleEffect>
				{
					new BattleEffect
					{
