...
namespace ABH.GameDatas
{
	public class SkillGameData
	{
		...
		{
			get { return Balancing.IconAssetId; }
		}
		...
		{
			var skillBattleDataBase = Activator.CreateInstance(Type.GetType("ABH.GameDatas.Battle.Skills." + Balancing.SkillTemplateType, true, true)) as SkillBattleDataBase;
