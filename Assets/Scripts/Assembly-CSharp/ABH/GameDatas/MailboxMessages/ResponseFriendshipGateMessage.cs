	...
	public class ResponseFriendshipGateMessage : BaseMailboxMessage
	{
		...
		public override string ContentDescription
		{
			get
			{
				...
				var balancingData = DIContainerBalancing.Service.GetBalancingData<HotspotBalancingData>(m_Message.Parameter1);
		...
		public override bool UseMessageContent(PlayerGameData player, Action<bool, IMailboxMessageGameData> callbackWhenDone)
		{
			...
			var friendShipGateUnlocks = DIContainerInfrastructure.GetCurrentPlayer().SocialEnvironmentGameData.Data.FriendShipGateUnlocks;
			var newFriendShipGateUnlocks = DIContainerInfrastructure.GetCurrentPlayer().SocialEnvironmentGameData.Data.NewFriendShipGateUnlocks;
