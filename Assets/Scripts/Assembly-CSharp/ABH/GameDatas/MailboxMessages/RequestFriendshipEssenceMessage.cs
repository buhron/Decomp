...
{
	public class RequestFriendshipEssenceMessage : BaseMailboxMessage
	{
		...
		public override string ContentDescription
		{
			get
			{
				...
				return DIContainerInfrastructure.GetLocaService().Tr("social_ask_friendship_essence", dictionary);
			}
		}
		...
		public override MessageInfo ResponseMessage
		{
			get
			{
				...
				messageInfo.MessageType = MessageType.ResponseFriendshipEssenceMessage;
				return messageInfo;
			}
		}
