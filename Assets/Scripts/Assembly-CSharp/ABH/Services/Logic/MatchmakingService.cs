...
namespace ABH.Services.Logic
{
	public class MatchmakingService : IMatchmakingService
	{
		...
		{
			m_onlineMatchmaker = new OnlineMatchmaker(ContentLoader.Instance.m_BeaconConnectionMgr.Identity);
			m_offlineMatchmaker = new OfflineMatchmaker(ContentLoader.Instance.m_BeaconConnectionMgr.Identity);
		}
