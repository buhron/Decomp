...
public class HotSpotWorldMapViewGoldenPig : MonoBehaviour
{
	...
	public void ShowTooltip()
	{
		...
		{
			var firstPossibleBattle = DIContainerLogic.GetBattleService().GetFirstPossibleBattle(Model.BalancingData.BattleId, DIContainerInfrastructure.GetCurrentPlayer());
