...
public class HatchHelper
{
	...
	{
		var dictionary = new Dictionary<string, Rcs.Assets.Info>();
		foreach (var key in hatchDic.Keys)
		{
	...
	{
		var dictionary = new Dictionary<string, Variant>();
