...
public class BannerItemInfo : MonoBehaviour
{
	...
	{
		if (m_SelectedBannerItem != null && m_PerkSprite)
		{
	...
	private UIAtlas GetSkillAtlas()
	{
		...
		{
			var gameObject = DIContainerInfrastructure.GetGenericIconAtlasAssetProvider().GetObject(m_BannerSkill.Balancing.IconAtlasId) as GameObject;
