...
public class DllLocaLoaderImpl : ILocaLoader
{
	...
	{
		var type = Type.GetType("Chimera.AngryBirdsHeroes.Localization." + language + ",Chimera.AngryBirdsHeroes.Localization");
		var field = type.GetField("Texts", BindingFlags.Static | BindingFlags.Public);
		var result = (Dictionary<string, string>)field.GetValue(null);
