...
public class XPBarController : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		SetNeededXP();
		var experience = DIContainerInfrastructure.GetCurrentPlayer().Data.Experience;
		var num = experience / neededXPForLevelUp;
	...
	private IEnumerator LevelUpCoroutine(int level)
	{
		...
		SetNeededXP();
		var percentageOldLevel = 1f - m_OldPercentage;
		var percentageNewLevel = DIContainerInfrastructure.GetCurrentPlayer().Data.Experience / neededXPForLevelUp;
		var percentageSum = percentageOldLevel + percentageNewLevel;
	...
	private IEnumerator UpdateXPBarValue()
	{
		...
		{
			m_Updating = true;
			var target = DIContainerInfrastructure.GetCurrentPlayer().Data.Experience;
			var targetPercent = target / neededXPForLevelUp;
			m_FillAnimationSprite.fillAmount = m_OldPercentage;
			m_FillIndikatorSprite.fillAmount = targetPercent;
			var currentPercent = m_OldPercentage;
