...
public class LootWheelController : MonoBehaviour
{
	...
	public void SetLootIcons(string lootTableNameId, int level, int stars)
	{
		...
		for (var j = 0; j < balancing.LootTableEntries.Count; j++)
		{
			var lootTableEntry = balancing.LootTableEntries[j];
		...
		for (var k = 0; k < m_itemListContainer.Count; k++)
		{
