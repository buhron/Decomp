...
public class PopupSingleBirdRevive : MonoBehaviour
{
	...
	public void SetModel(BattleUIStateMgr battleUIStateMgr, ICombatant knockedOutBird)
	{
		...
		var characterControllerCamp = Object.Instantiate(m_CharacterCampPrefab);
		...
		var reviveSingleBirdsRequirement = DIContainerBalancing.GameConstantsBalancingDataProvider.ReviveSingleBirdsRequirement;
		var balancingData = DIContainerBalancing.GetInventoryItemBalancingDataPovider().GetBalancingData(reviveSingleBirdsRequirement.NameId);
	...
	private void ReviveButtonClicked()
	{
		...
		{
			var requirement = reviveSingleBirdsRequirement;
	...
	private IEnumerator LeaveCoroutine()
	{
		if (m_isActive)
		{
			...
			if (m_CharacterSpawnRoot.GetChild(0))
			{
