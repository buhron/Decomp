...
public class EnchantingItemSlot : InventoryItemSlot
{
	...
	public void EnableEnchanting(EnchantmentUI parent)
	{
		...
		var componentsInChildren = m_EnchantingPlusButton.GetComponentsInChildren<UIPlayAnimation>();
		foreach (var uIPlayAnimation in componentsInChildren)
		{
			uIPlayAnimation.enabled = true;
		}
		var componentsInChildren2 = m_EnchantingMinusButton.GetComponentsInChildren<UIPlayAnimation>();
		foreach (var uIPlayAnimation2 in componentsInChildren2)
		{
