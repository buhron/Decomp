...
public class DungeonInfoPopup : MonoBehaviour
{
	...
	[SerializeField]
	private Animation m_SideBoardAnimation;
	...
	private IEnumerator LeaveCoroutine()
	{
		...
		m_SideBoardAnimation.Play("SideBoard_Leave");
	...
	public void Show(List<DungeonInfo> dungeonList)
	{
		...
		{
			var id = 0;
			for (var i = 0; i < m_tabAnimators.Length; i++)
			{
	...
	private IEnumerator EnterCoroutine()
	{
		...
		m_SideBoardAnimation.Play("SideBoard_Enter");
	...
	private void OnDungeonTabClicked(int id)
	{
		...
		var dungeonInfo = m_dungeonInfos[id];
