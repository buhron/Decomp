...
public class PanelClippingLayoutControl : MonoBehaviour
{
	...
	public void Start()
	{
		var size = new Vector2(m_ContainerControll.m_Size.x * m_Scale.x, m_ContainerControll.m_Size.y * m_Scale.y);
		var vector = new Vector2(m_DragPanel.panel.baseClipRegion.x, m_DragPanel.panel.baseClipRegion.y);
		if (m_ChangeCenter)
		{
