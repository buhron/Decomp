...
public class ResourceManager : MonoBehaviour
{
	...
	{
		var gameObject = UnityEngine.Object.Instantiate(m_resourcePrefabs[0]);
	...
	public void LateInit()
	{
		...
		for (var i = 0; i < m_spotList.Count; i++)
		{
			var hotSpotWorldMapViewResource = m_spotList[i];
	...
	private void CheckGlobalCoolDown()
	{
		...
		for (var i = 0; i < m_timeStampList.Count; i++)
		{
