...
public class StorageUnityImplAsync : IStorageServiceAsync
{
	...
	{
		var @int = PlayerPrefs.GetInt(key);
	...
	{
		var @int = PlayerPrefs.GetInt(key, standardValue);
		if (onValueReceived != null)
		{
			onValueReceived(@int);
		}
	...
	{
		var @float = PlayerPrefs.GetFloat(key);
		if (onValueReceived != null)
		{
	...
	{
		var @float = PlayerPrefs.GetFloat(key, standardValue);
		if (onValueReceived != null)
		{
			onValueReceived(@float);
		}
	...
	{
		var @string = PlayerPrefs.GetString(key);
		if (onValueReceived != null)
		{
	...
	{
		var @string = PlayerPrefs.GetString(key, standardValue);
		if (onValueReceived != null)
		{
			onValueReceived(@string);
		}
