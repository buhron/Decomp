...
static public class NGUIContextMenu
{
	...
	static void ShowHelp25 (MenuCommand command) { NGUIHelp.Show(typeof(ActiveAnimation)); }

	[MenuItem("CONTEXT/UIPanel/Help")]
	static void ShowHelp26 (MenuCommand command) { NGUIHelp.Show(typeof(UIPanel)); }

	[MenuItem("CONTEXT/UILocalize/Help")]
	static void ShowHelp27 (MenuCommand command) { NGUIHelp.Show(typeof(UILocalize)); }

	[MenuItem("CONTEXT/Localization/Help")]
	static void ShowHelp28 (MenuCommand command) { NGUIHelp.Show(typeof(Localization)); }

	[MenuItem("CONTEXT/UIKeyNavigation/Help")]
	static void ShowHelp29 (MenuCommand command) { NGUIHelp.Show(typeof(UIKeyNavigation)); }
	
	[MenuItem("CONTEXT/PropertyBinding/Help")]
	static void ShowHelp30 (MenuCommand command) { NGUIHelp.Show(typeof(PropertyBinding)); }
