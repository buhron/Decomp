		...
		switch (rageSpline.GetPhysics()) {
			...
			case RageSpline.Physics.OutlineMeshCollider:
				...
				if (physicsOptions) {
					...
					rageSpline.SetPhysicsMaterial(EditorGUILayout.ObjectField("      Physics material", rageSpline.GetPhysicsMaterial(), typeof(PhysicsMaterial), false) as PhysicsMaterial);
			...
			case RageSpline.Physics.Boxed:
				...
				if (physicsOptions) {
					...
					rageSpline.SetPhysicsMaterial(
						EditorGUILayout.ObjectField("      Physics material", rageSpline.GetPhysicsMaterial(), typeof(PhysicsMaterial),
													false) as PhysicsMaterial);
					rageSpline.PhysicsIsTrigger = EditorGUILayout.Toggle("      Physics Set Trigger", rageSpline.PhysicsIsTrigger);
