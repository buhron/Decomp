...
public class RageTriangulator : ScriptableObject, IRageTriangulator
{
    ...
    public float Area(List<Vector2> m_points)
    {
        int n = m_points.Count;
        float A = 0.0f;
    ...
    public bool Snip(int u, int v, int w, int n, int[] V, List<Vector2> m_points)
    {
        int p;
